...
def send_simple_message():
    return requests.post(
        "https://api.mailgun.net/v3/sandbox74e4c67397664773b921610cad095829.mailgun.org/messages",
        auth=("api", "b8029ef01d614426f177abf91cc47fd5-060550c6-036ea646"),
...
payload = {"q": "London,UK", "units":"metric", "appid":"2649b4e829d8b87fe6bf1587afb9b7ba"}
...
print("-----exp2-------")
endpoint = "http://api.openweathermap.org/data/2.5/weather"
payload = {"q": "Constanta,Romania", "units":"metric", "appid":"2649b4e829d8b87fe6bf1587afb9b7ba"}
response = requests.get(endpoint, params=payload)
print (response.url)
print("-----------------")
print (response.headers["content-type"])
