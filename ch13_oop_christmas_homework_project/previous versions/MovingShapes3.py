...
class Diamond(MovingShape):
    def __init__(self,frame,diameter):
        ...
        self.minx=self.diameter*math.sqrt(2)/2
        self.miny=self.diameter*math.sqrt(2)/2
        self.maxx=self.frame.width-self.minx+1
        self.maxy=self.frame.height-self.miny+1
