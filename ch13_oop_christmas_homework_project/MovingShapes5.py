...
class MovingShape:
    def __init__(self,frame,shape,diameter):
        ...
        self.dx=self.getRandomXDirection()               #rate of movement for x (how much distance it covers in 1 step and which direction,positive or negative)
        self.dy=self.getRandomYDirection()                  #rate of movement for y (how much distance it covers in 1 step and which direction,positive or negative)
        self.goto(self.x,self.y)                         #starting position 
    
    def getRandomXDirection(self):
