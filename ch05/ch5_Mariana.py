...
Snoopy=Dog()            # creating an object Snoopy with the subclass Dog and class Animal
#Snoopy.bark()              #subclass method
#Snoopy.eat()               #superclass method

Pissy=Cat()             # creating an object Pissy with the subclass Cat and class Animal
...
class SuperRobot():
    def __init__(self,name):
        self.first=Robot()
        self.second=Dog()
        self.third=CleanRobot()
        self.forth=CookRobot()
        self.name=name
    def playGame(self):
        print("alphago game")
    def move(self):
...
machineDog=SuperRobot(Robotica)
#machineDog.move()
#machineDog.bark()
#machineDog.playGame()
time=int(input("At what hour did you arrive home?"))
